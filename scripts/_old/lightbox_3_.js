const PROJECTS = {
  archviz_Overpass: {
    ...
    images: [
      {
        src: "images/dcal_fortaleny-11-c.jpg",
        cap: "Aerial view day",
      },
      { src: "images/dcal_pont-de-ferro-02.jpg", cap: "Night aerial" },
      { src: "images/dcal_n-autovia-00.jpg", cap: "Highway night" },
      { src: "images/dcal_hwy-11.jpg", cap: "Highway day" },
      { src: "images/dcal_3rd-person-02.jpg", cap: "Bridge walkthrough" },
      { src: "images/dcal_aerial-12.jpg", cap: "Roundabout" },
    ],
  },
  archviz_MainStr: {
    ...
    images: [
      {
        beforeAfter: true,
        before: "images/alborache_bus_before.jpg",
        after: "images/alborache_bus_after.jpg",
        cap: "Bus stop · Before & After",
      },
            {
        beforeAfter: true,
        before: "images/alborache_church_before.jpg",
        after: "images/alborache_church_after.jpg",
        cap: "Church · Before & After",
      },      {
        beforeAfter: true,
        before: "images/alborache_street_before.jpg",
        after: "images/alborache_street_after.jpg",
        cap: "Main street · Before & After",
      },      {
        beforeAfter: true,
        before: "images/alborache_loadzone_before.jpg",
        after: "images/alborache_loadzone_after.jpg",
  ...
  motorsport_F2: {
    ...
    subtitle:
      "Town square renovation. Location: Otos (Valencia, Spain).",
    images: [
      {
        beforeAfter: true,
...
function renderLightbox() {
  ...
  if (img.turntable) {
    ...
    const onDown = e => { ttDragging = true; ttLastX = e.clientX; ttFrameAtStart = ttFrame; ttEl.style.cursor = "grabbing"; ttEl.setPointerCapture(e.pointerId); stopTTAuto(); };
    const onMove = e => { if (!ttDragging) return; showTTFrame(ttFrameAtStart - Math.round((e.clientX - ttLastX) / DRAG_SENS)); };
    const onUp   = () => { ttDragging = false; ttEl.style.cursor = "grab"; startTTAuto(); };
...
const HERO_IMGS = [
  ...
  "images/dcal_superformula-render-wire-01.jpg",
