const T = {
  en: {
    ...
    'f-archviz': 'Archviz', 'f-simulation': 'Simulation', 'f-motorsport': 'Motorsport', 'f-other': 'Other',
    'about-label': 'About', 'about-title': 'About me.',
    ...
    'about-timeline': 'Career', 'about-education': 'Education', 'about-skills': 'Skills',
    'tl0-role': 'Turnaround Coordinator', 'tl0-co': 'Manises Airport (Valencia)',
    'tl1-role': 'Freelance 3D Generalist', 'tl1-co': 'Self-employed \u00b7 Remote and hybrid work',
    ...
    'tl5-role': 'Localization Department', 'tl5-co': 'Nintendo of Europe \u00b7 Frankfurt am Main',
    ...
    's2t': 'Modelling', 's2d': 'Built in Blender, with ZBrush for organic detail. Polygon budget matched to the target engine — simulator assets stay lean; archviz can go deeper.',
    's3d': 'Blender Cycles for photorealistic stills. EEVEE or Unreal Engine when real-time output is needed. Materials authored in Substance Painter or Blender nodes.',
    's4t': 'Delivery', 's4d': 'Post-production in Affinity Photo. Client review round included. Final files in the agreed formats and resolutions, with source files on request.',
    ...
    'form-submit': 'Send message \u2192', 'footer-copy': '\u00a9 2026 Daniel Cal \u2014 3D Generalist'
  },
  es: {
    ...
    'f-archviz': 'Archviz', 'f-simulation': 'Simulaci\u00f3n', 'f-motorsport': 'Motorsport', 'f-other': 'Otros',
    ...
    'about-timeline': 'Trayectoria', 'about-education': 'Formaci\u00f3n', 'about-skills': 'Habilidades',
    'tl0-role': 'Coordinador de pista', 'tl0-co': 'Aeropuerto de Manises (Valencia)',
    'tl1-role': 'Generalista 3D Freelance', 'tl1-co': 'Aut\u00f3nomo \u00b7 Trabajo remoto e h\u00edbrido',
    ...
    'tl5-role': 'Departamento de Localizaci\u00f3n', 'tl5-co': 'Nintendo of Europe \u00b7 Frankfurt am Main',
    ...
    's2t': 'Modelado', 's2d': 'Modelado en Blender, con ZBrush para detalles orgánicos. El presupuesto de polígonos se ajusta al motor destino: los assets de simulador se mantienen ligeros; el archviz puede ir más lejos.',
    's3d': 'Blender Cycles para imágenes fotorrealistas. EEVEE o Unreal Engine cuando se necesita salida en tiempo real. Materiales creados en Substance Painter o con nodos de Blender.',
    's4t': 'Entrega', 's4d': 'Postproducción en Affinity Photo. Ronda de revisión con el cliente incluida. Archivos finales en los formatos y resoluciones acordados, con archivos fuente bajo petición.',
    ...
    'form-submit': 'Enviar mensaje \u2192', 'footer-copy': '\u00a9 2026 Daniel Cal \u2014 Generalista 3D'
  }
};
let lang = 'en';
